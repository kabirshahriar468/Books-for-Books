...
const addressInput = document.getElementById("inputLocation");
const passwordInput = document.getElementById("inputPassword");
const photoInput = document.getElementById("inputPhoto");
...
async function processInput(event) {
    ...
    const publisherName = authorNameInput.value;
    ...
    try {
        const response = await fetch(`/publishersignup`,{method: 'POST'
        , body: formData});
